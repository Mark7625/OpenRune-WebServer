...
abstract class BaseExtractor(
    ...
    private var progressMax: Long = 0
    ...
    fun getProgressPercentage(): Double {
        if (progressMax == 0L) return 0.0
        return (progressCurrent.toDouble() / progressMax.toDouble()) * 100.0
    }
    
    /**
     * Get current progress info (current, max)
     */
    fun getProgressInfo(): Pair<Long, Long> {
        return Pair(progressCurrent, progressMax)
    }
