...
import dev.openrune.cache.util.XteaLoader.getKeys
...
class RegionLoader {
    ...
    fun loadRegionFromArchive(regionId: Int): Region? {
        ...
        val map: ByteArray = CacheManager.cache.data(5, "m" + x + "_" + y) ?: return null
        var data = map
        ...
        if (keys != null) {
            data = CacheManager.cache.data(5, "l" + x + "_" + y, keys)!!
